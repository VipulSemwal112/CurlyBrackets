...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/vipulsemwal/Desktop/PsycopyStudy/Editing Final response time Image middle/FINAL/Psycopy  Final2/EyeTrackingStudy_lastrun.py',
