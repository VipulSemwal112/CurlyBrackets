...
function Code_intialRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Code_intialComponents)
...
function Study_StructureRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Study_StructureComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Start_TaskRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Start_TaskComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function EEG_SetupRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of EEG_SetupComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Index_update3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Index_update3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Update_IndexRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Update_IndexComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function userRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of userComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function EEGRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of EEGComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
